  ...
  return (
    <div className="flex flex-col w-full relative">
      <div className="pb-7 border-b-2 w-full h-fit md:px-10">
        ...
        <form
          action="#"
          className="flex flex-col md:flex-row items-center md:items-start gap-5 justify-center md:justify-normal"
          onSubmit={addModel}
        >
          <div className="w-full md:w-auto flex gap-5 justify-center md:justify-normal">
            <div className="flex flex-col gap-2">
              <select
                onChange={selectClient}
                className="h-fit bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-teal-500 focus:border-teal-500 block p-2.5 md:mt-3"
              >
            ...
            <div className="flex gap-4">
              ...
              <div className="flex flex-col text-center">
                ...
                <input
                  ...
                  onChange={checkFans}
                  value={fansInput}
                  className="ring-2 ring-teal-700 rounded-sm w-12 text-center"
                />
              </div>
            </div>
          </div>
          <div id="fechaProg" className=" hidden">
          ...
          <button className="px-3 py-2 bg-teal-600 text-white rounded-sm hover:bg-teal-500 md:mt-3">
            Asignar
          </button>
        </form>
      </div>
